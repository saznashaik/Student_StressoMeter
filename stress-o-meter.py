...
# User input page for stress level prediction
if choice == "User input":
    ...
    stress_model = pickle.load(open(r"C:/Users/Sazna/Downloads/STUDENT_MENTAL_HEALTH (3).sav", 'rb'))
    course_mapping = {
...
if choice == "For Queries":
    ...
    image = Image.open('C:/Users/Sazna/Downloads/stress.jpeg')
